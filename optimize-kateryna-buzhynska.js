...
/**
 * Image Optimization Script for Kateryna Buzhynska event images
 ...
 * 
 * Usage:
 * node optimize-kateryna-buzhynska.js
 */
...
const imagesDir = path.join(__dirname, 'assets/images/events/KaterynaBuzhynska');
...
if (imageFiles.length === 0) {
  console.log('❌ No JPG files found in KaterynaBuzhynska directory');
  process.exit(1);
}
...
async function optimizeImage(imageFile) {
  ...
  // Sizes for event images (similar to olya_newyear)
  const sizes = [
    { width: 1000, suffix: '' },
...
async function main() {
  console.log('🚀 Starting image optimization for Kateryna Buzhynska images...\n');
